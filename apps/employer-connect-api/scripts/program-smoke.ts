...
// accumulated by prior runs in a persistent local store (ready_to_submit keys off
// the candidate's employerShareConsent field, so a plain 'TX' would also match old rows).
