...
// Employer surfaces never expose visa. Default runs on Postgres/PGlite; SQLite
// requires ATS_DB=sqlite ALLOW_SQLITE_LOCAL_DEV=1.
...
// ── Slate: visa-blocked drops to gatePending (employer sees only cleared) ─────
...
ok('employer-view: packet payload contains NO financing, passport number, DS-160, or SEVIS', !/financ|passport|ds[-_]?160|sevis/i.test(JSON.stringify(pkt.sharedFields)))
