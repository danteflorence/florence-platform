...
async function main() {
  ...
  const pq = pricingQuoteModel({ monthlyFeePerRnUsd: 1750, effectiveCostPerRnMonthUsd: 1050, channel: 'direct', note: 'FICA offset is customer effective-cost, never Florence Education revenue.' })
