...
if (!econMissing) ok('Gap A: payDisplay labels estimate as Florence local-market', payDisplay(estAfter).kind === 'estimated' && /Florence estimate/.test(payDisplay(estAfter).source))
