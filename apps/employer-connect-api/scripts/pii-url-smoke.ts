...
async function main() {
  ...
  const link = await createLink({ destinationUrl: 'https://app.florenceedu.com/jobs/abc', utmSource: 'amn', utmMedium: 'email', utmCampaign: 'kaiser_nv', campaignType: 'partner' })
