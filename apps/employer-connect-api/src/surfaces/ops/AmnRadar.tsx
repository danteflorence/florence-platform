// AMN Account Radar — account-level cockpit: open RN demand × Florence Education supply ×
  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-slate-500">Account-level RN demand × Florence Education supply × economics × opportunity value. Highest-yield accounts first. Briefs are DRAFTS — human review before any send; no financing/underwriting data ever appears.</p>
      </div>
