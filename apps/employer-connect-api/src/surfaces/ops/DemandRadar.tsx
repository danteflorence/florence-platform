...
export default function DemandRadar() {
  ...
  return (
    <div className="space-y-6">
      ...
      {d.pay && (
        <Card>
          <CardHeader title="Compensation transparency" subtitle="Listed pay comes from the employer posting; estimated pay is a Florence Education local-market estimate — never presented as posted." />
          <div className="grid grid-cols-2 gap-4 px-5 py-4 sm:grid-cols-4">
            ...
            <div><div className="text-xs uppercase tracking-wide text-slate-500">Florence estimate</div><div className="mt-1 text-2xl font-bold text-florence-700">{d.pay.estimated}</div></div>
      ...
      {d.opportunityStates && (
        <Card>
          <CardHeader title="Opportunity reachability" subtitle="How open jobs reach candidates today. 'Apply with Florence Education packet' is offered only for direct-partner / ATS-connected; everything else is express-interest." />
          <div className="grid grid-cols-2 gap-4 px-5 py-4 sm:grid-cols-4">
