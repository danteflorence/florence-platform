  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-slate-500">Nurses who expressed interest, the exact gates blocking submission, and expected release. Florence Education submits only after consent + visa + license + QA clear — interviews, offers, and starts remain subject to consular processing, final work authorization, credentialing, onboarding, and employer approval.</p>
      </div>
