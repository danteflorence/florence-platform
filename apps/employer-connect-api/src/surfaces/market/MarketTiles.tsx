// PUBLIC category interest tiles (/markets). Shows where Florence Education sees RN demand by
...
export default function MarketTiles() {
  ...
  return (
    <div className="mx-auto min-h-screen max-w-4xl px-4 py-10">
      ...
      <p className="mt-8 text-center text-xs text-slate-400">Expressing interest is not a job application. Florence Education aggregates nurse interest by market to bring licensed RN opportunities to you — nothing is shared with an employer until you’re licensed and consent.</p>
            ...
            <>
              ...
              <div className="mt-4 space-y-3">
                ...
                <label className="flex items-start gap-2 text-sm text-slate-600">
                  ...
                  <span>I consent to Florence Education contacting me about RN opportunities in this market. Nothing is shared with an employer until I’m licensed and give separate consent.</span>
                </label>
