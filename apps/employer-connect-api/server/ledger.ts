...
const STAGE_TO_PASSPORT: Partial<Record<LedgerStage, string>> = {
  matched: 'ats.matched',
  packet_created: 'employer_packet.created',
  qa_approved: 'employer_packet.qa_approved',
  ...
  start_scheduled: 'ats.start_scheduled',
  started: 'ats.started',
  ...
  repayment: 'financing.repayment',
  visa_approved: 'application.work_authorization_cleared',
  license_verified: 'application.license_verified',
  application_ready_to_submit: 'application.ready_to_submit',
  interview_pre_clearance_requested: 'ats.pre_clearance_requested',
