...
export const ledgerEventSchema = z.object({
  ...
  stage: z.enum([
    ...
    'started', 'rejected', 'withdrawn', 'retention_30d', 'retention_60d',
    'retention_90d', 'term_complete', 'repayment', 'visa_approved',
    'license_verified', 'application_ready_to_submit',
    'interview_pre_clearance_requested', 'interview_formal_scheduled',
    'offer_received_subject_to_clearance', 'start_cleared',
  ]),
...
export const createProgramSchema = z.object({
  ...
  channel: z.enum(['amn', 'kaiser', 'tenet', 'direct_employer', 'vms_partner', 'direct']).default('amn'),
