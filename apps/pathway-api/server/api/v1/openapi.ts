...
// here). Part of the Florence OS Platform API (Pathway capability module).
export const PATHWAY_OPENAPI: Record<string, unknown> = {
  openapi: '3.1.0',
  info: {
    title: 'Florence OS Platform API — Pathway capability',
    version: 'v1',
    description:
  ...
  servers: [
    { url: 'https://api.florenceedu.com/v1', description: 'Production' },
    { url: 'https://sandbox-api.florenceedu.com/v1', description: 'Sandbox' },
  ],
  components: {
    securitySchemes: {
  ...
  paths: {
    ...
    '/pathway/qa/queues': { get: { summary: 'Staff-only Pathway QA queues for DS-160, I-901 receipt, visa appointment, and SEVISmate follow-up.', responses: { '200': { description: 'ok' }, '401': { description: 'auth required' }, '403': { description: 'staff role required' } } } },
  },
}
