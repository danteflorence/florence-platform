...
/** Official SSA guidance for applying for an SSN. Off-platform, online-start plus office completion. */
export const SSA_RESOURCES: OfficialResource[] = [
  {
    ...
    note: 'Your F-1 program’s CPT (handled by your university) makes you SSN-eligible; SSA says to start online, then complete the request at an SSA office/Card Center with documents within 45 calendar days.',
  },
  {
    label: 'SSA — Request a Social Security number for the first time',
    url: 'https://www.ssa.gov/number-card/request-number-first-time',
    note: 'If you are in the U.S., SSA lets you apply online and then visit a local office with documentation; the card is mailed after approval.',
  },
  {
    label: 'SSA — Field Office Locator',
    url: 'https://www.ssa.gov/locator/',
    note: 'Use the official SSA locator to find the office or Card Center for the required document visit.',
  },
]
