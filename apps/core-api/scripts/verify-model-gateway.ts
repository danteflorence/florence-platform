...
function firstExisting(...roots: string[]): string {
  return roots.find((root) => existsSync(root)) ?? roots[0];
}

const scannedRoots = [
  "src",
  firstExisting("../academy-web/api/src", "../florence-academy/api/src"),
  firstExisting("../academy-web/api/scripts", "../florence-academy/api/scripts"),
  firstExisting("../pathway-api/server", "../florence-pathway-agent/server"),
  firstExisting("../employer-connect-api/server", "../florence-ats-connect/server"),
];
