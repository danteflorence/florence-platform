...
export interface Config {
  port: number;
  /** Public origin of Core, e.g. https://auth.florenceedu.com */
  publicUrl: string;
...
export const config: Config = {
  ...
  allowedEmailDomains: list("FLORENCE_ALLOWED_DOMAIN", "florenceedu.com"),
  redirectHostSuffixes: list("FLORENCE_REDIRECT_HOSTS", ".florenceedu.com,.lvh.me,localhost"),
  google: {
