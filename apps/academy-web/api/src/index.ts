...
// Trust Florence Core's RS256 SSO token (verified via JWKS). Configured from
...
if (databaseUrl) {
  ...
  if (process.env["NODE_ENV"] === "production") {
    throw new Error("DATABASE_URL is required in production; Academy API must use Postgres.");
  }
