...
const DEFAULT_APPLY_PLACEMENTS: ApplyCTAPlacement[] = [
  "academy_home",
  "checkout_success",
  "class_page",
  "live_class",
...
export const DEFAULT_APPLY_CTAS: ApplyCTA[] = DEFAULT_APPLY_PLACEMENTS.map((placement) => ({
  id: placement === "academy_home" ? "academy-global-live-apply" : `academy-global-live-apply-${placement.replace(/_/g, "-")}`,
  placement,
  label: APPLY_LABEL,
