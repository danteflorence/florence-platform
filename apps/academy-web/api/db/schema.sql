...
CREATE TABLE IF NOT EXISTS academy_library_resources (
  id            text PRIMARY KEY,
  kind          text NOT NULL CHECK (kind IN ('document','external_embed')),
  title         text NOT NULL,
  description   text,
  visibility    text NOT NULL CHECK (visibility IN ('private','cohort','academy')),
  candidate_id  text REFERENCES candidates (id),
  cohort        text,
  tags          text[] NOT NULL DEFAULT '{}',
  document      jsonb,
  embed         jsonb,
  content_enc   text,                         -- ENCRYPTED document body: base64 AES-256-GCM envelope
  created_by    text NOT NULL,
  created_at    timestamptz NOT NULL DEFAULT now(),
  updated_at    timestamptz NOT NULL DEFAULT now(),
  CHECK (
    (kind = 'document' AND document IS NOT NULL AND content_enc IS NOT NULL AND embed IS NULL)
    OR
    (kind = 'external_embed' AND embed IS NOT NULL AND document IS NULL AND content_enc IS NULL)
  )
);
CREATE INDEX IF NOT EXISTS idx_library_resources_candidate ON academy_library_resources (candidate_id, created_at);
CREATE INDEX IF NOT EXISTS idx_library_resources_visibility ON academy_library_resources (visibility, created_at);
CREATE INDEX IF NOT EXISTS idx_library_resources_cohort ON academy_library_resources (cohort, created_at);
...
VALUES
  ...
  ('academy-global-live-apply-checkout-success', 'checkout_success', 'Apply to U.S. Partner Programs',
   'Application fees are covered by Florence for eligible applicants.',
   'https://www.florenceedu.com/apply', 'global-live-access', true,
   '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z'),
  ('academy-global-live-apply-class-page', 'class_page', 'Apply to U.S. Partner Programs',
   'Application fees are covered by Florence for eligible applicants.',
   'https://www.florenceedu.com/apply', 'global-live-access', true,
   '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z'),
  ('academy-global-live-apply-live-class', 'live_class', 'Apply to U.S. Partner Programs',
   'Application fees are covered by Florence for eligible applicants.',
   'https://www.florenceedu.com/apply', 'global-live-access', true,
   '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z'),
  ('academy-global-live-apply-class-completion', 'class_completion', 'Apply to U.S. Partner Programs',
   'Application fees are covered by Florence for eligible applicants.',
   'https://www.florenceedu.com/apply', 'global-live-access', true,
   '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z'),
  ('academy-global-live-apply-diagnostic-result', 'diagnostic_result', 'Apply to U.S. Partner Programs',
   'Application fees are covered by Florence for eligible applicants.',
   'https://www.florenceedu.com/apply', 'global-live-access', true,
   '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z'),
  ('academy-global-live-apply-sponsor-card', 'sponsor_card', 'Apply to U.S. Partner Programs',
   'Application fees are covered by Florence for eligible applicants.',
   'https://www.florenceedu.com/apply', 'global-live-access', true,
   '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z'),
  ('academy-global-live-apply-residency-page', 'residency_page', 'Apply to U.S. Partner Programs',
   'Application fees are covered by Florence for eligible applicants.',
   'https://www.florenceedu.com/apply', 'global-live-access', true,
   '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z'),
  ('academy-global-live-apply-grant-center', 'grant_center', 'Apply to U.S. Partner Programs',
   'Application fees are covered by Florence for eligible applicants.',
   'https://www.florenceedu.com/apply', 'global-live-access', true,
   '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z')
ON CONFLICT (id) DO NOTHING;
...
-- ── Academy Live Residency Manager + Florence Access Grants ─────────────────
CREATE TABLE IF NOT EXISTS academy_residencies (
  id          text PRIMARY KEY,
  location    text NOT NULL CHECK (location IN ('manila','los_angeles')),
  name        text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_residencies_location ON academy_residencies (location, starts_at);

CREATE TABLE IF NOT EXISTS academy_camps (
  id             text PRIMARY KEY,
  residency_id   text NOT NULL REFERENCES academy_residencies (id),
  name           text NOT NULL,
  camp_option    text NOT NULL CHECK (camp_option IN ('morning','evening')),
  contact_hours  integer NOT NULL CHECK (contact_hours = 20),
  seat_capacity  integer NOT NULL CHECK (seat_capacity IN (50,75,100)),
  status         text NOT NULL DEFAULT 'scheduled'
                 CHECK (status IN ('scheduled','active','completed','cancelled')),
  starts_at      timestamptz NOT NULL,
  ends_at        timestamptz NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_camps_residency ON academy_camps (residency_id, starts_at);

CREATE TABLE IF NOT EXISTS academy_camp_reservations (
  id             text PRIMARY KEY,
  candidate_id   text NOT NULL REFERENCES candidates (id),
  camp_id        text NOT NULL REFERENCES academy_camps (id),
...
CREATE INDEX IF NOT EXISTS idx_camp_reservations_candidate ON academy_camp_reservations (candidate_id, created_at);
CREATE INDEX IF NOT EXISTS idx_camp_reservations_camp ON academy_camp_reservations (camp_id, status);

CREATE TABLE IF NOT EXISTS academy_faculty_assignments (
  id            text PRIMARY KEY,
  camp_id       text NOT NULL REFERENCES academy_camps (id),
...
CREATE INDEX IF NOT EXISTS idx_faculty_assignments_camp ON academy_faculty_assignments (camp_id);

CREATE TABLE IF NOT EXISTS academy_livestream_lanes (
  id          text PRIMARY KEY,
  camp_id     text NOT NULL REFERENCES academy_camps (id),
  name        text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_livestream_lanes_camp ON academy_livestream_lanes (camp_id);

CREATE TABLE IF NOT EXISTS academy_gap_calculations (
  id                  text PRIMARY KEY,
  candidate_id        text NOT NULL REFERENCES candidates (id),
  pathway_stage       text NOT NULL,
  estimated_gap_usd   integer NOT NULL,
  verified_gap_usd    integer NOT NULL,
  max_grant_usd       integer NOT NULL DEFAULT 5000,
  eligible_amount_usd integer NOT NULL,
  status              text NOT NULL DEFAULT 'gap_identified'
                      CHECK (status IN ('gap_identified','documents_missing','gap_verified')),
  documents_required  text[],
  created_at          timestamptz NOT NULL DEFAULT now(),
  updated_at          timestamptz NOT NULL DEFAULT now()
);
CREATE INDEX IF NOT EXISTS idx_gap_calculations_candidate ON academy_gap_calculations (candidate_id, created_at);

CREATE TABLE IF NOT EXISTS academy_access_grants (
  id                   text PRIMARY KEY,
  candidate_id          text NOT NULL REFERENCES candidates (id),
  gap_calculation_id    text NOT NULL REFERENCES academy_gap_calculations (id),
  requested_amount_usd  integer NOT NULL,
  approved_amount_usd   integer,
  status                text NOT NULL DEFAULT 'gap_identified'
                        CHECK (status IN ('gap_identified','documents_missing','gap_verified',
                                          'eligible_for_review','approved','declined',
                                          'disbursement_pending','disbursed',
                                          'receipt_qa_approved','cancelled_refunded')),
  repayment_required    boolean NOT NULL DEFAULT false,
  employment_required   boolean NOT NULL DEFAULT false,
  created_at            timestamptz NOT NULL DEFAULT now(),
  updated_at            timestamptz NOT NULL DEFAULT now()
);
CREATE INDEX IF NOT EXISTS idx_access_grants_candidate ON academy_access_grants (candidate_id, created_at);
CREATE INDEX IF NOT EXISTS idx_access_grants_status ON academy_access_grants (status, created_at);

CREATE TABLE IF NOT EXISTS academy_grant_eligibilities (
  id                  text PRIMARY KEY,
  candidate_id        text NOT NULL REFERENCES candidates (id),
  gap_calculation_id  text NOT NULL REFERENCES academy_gap_calculations (id),
...
CREATE INDEX IF NOT EXISTS idx_grant_eligibilities_candidate ON academy_grant_eligibilities (candidate_id, created_at);

CREATE TABLE IF NOT EXISTS academy_grant_approval_queue (
  id               text PRIMARY KEY,
  access_grant_id  text NOT NULL REFERENCES academy_access_grants (id),
  status           text NOT NULL DEFAULT 'eligible_for_review'
                   CHECK (status IN ('eligible_for_review','approved','declined')),
  reviewer         text,
  queued_at        timestamptz NOT NULL DEFAULT now(),
  decided_at       timestamptz
);
CREATE INDEX IF NOT EXISTS idx_grant_approval_queue_status ON academy_grant_approval_queue (status, queued_at);

CREATE TABLE IF NOT EXISTS academy_disbursements (
  id                text PRIMARY KEY,
  access_grant_id   text NOT NULL REFERENCES academy_access_grants (id),
  amount_usd        integer NOT NULL,
  recipient_type    text NOT NULL CHECK (recipient_type IN ('school','vendor')),
  recipient_name    text NOT NULL,
  status            text NOT NULL DEFAULT 'disbursement_pending'
                    CHECK (status IN ('disbursement_pending','disbursed','cancelled_refunded')),
  direct_payment    boolean NOT NULL DEFAULT true,
  created_at        timestamptz NOT NULL DEFAULT now(),
  updated_at        timestamptz NOT NULL DEFAULT now(),
  disbursed_at      timestamptz
);
CREATE INDEX IF NOT EXISTS idx_disbursements_grant ON academy_disbursements (access_grant_id, created_at);

CREATE TABLE IF NOT EXISTS academy_receipts (
  id              text PRIMARY KEY,
  disbursement_id text NOT NULL REFERENCES academy_disbursements (id),
  status          text NOT NULL DEFAULT 'received'
                  CHECK (status IN ('received','receipt_qa_approved','rejected')),
  receipt_ref     text,
  created_at      timestamptz NOT NULL DEFAULT now(),
  updated_at      timestamptz NOT NULL DEFAULT now(),
  qa_at           timestamptz
);
CREATE INDEX IF NOT EXISTS idx_receipts_disbursement ON academy_receipts (disbursement_id, created_at);

CREATE TABLE IF NOT EXISTS academy_refund_policies (
  id          text PRIMARY KEY,
  name        text NOT NULL,
...
VALUES
  ('manila-2026-q3', 'manila', 'Manila 2026 Q3 Four-Week Residency', '2026-Q3',
   '2026-07-06T00:00:00Z', '2026-07-31T00:00:00Z', 'scheduled',
   '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z'),
  ('los-angeles-2026-q3', 'los_angeles', 'Los Angeles 2026 Q3 Live Residency', '2026-Q3',
   '2026-08-10T00:00:00Z', '2026-08-21T00:00:00Z', 'scheduled',
   '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z')
ON CONFLICT (id) DO NOTHING;

INSERT INTO academy_camps
  (id, residency_id, name, camp_option, contact_hours, seat_capacity, status,
   starts_at, ends_at, created_at, updated_at)
VALUES
  ('manila-2026-q3-morning-a', 'manila-2026-q3', 'Manila Morning Camp A',
   'morning', 20, 75, 'scheduled', '2026-07-06T08:00:00Z',
   '2026-07-10T12:00:00Z', '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z'),
  ('manila-2026-q3-evening-a', 'manila-2026-q3', 'Manila Evening Camp A',
   'evening', 20, 75, 'scheduled', '2026-07-06T18:00:00Z',
   '2026-07-10T22:00:00Z', '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z'),
  ('manila-2026-q3-morning-b', 'manila-2026-q3', 'Manila Morning Camp B',
   'morning', 20, 50, 'scheduled', '2026-07-20T08:00:00Z',
   '2026-07-24T12:00:00Z', '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z'),
  ('manila-2026-q3-evening-b', 'manila-2026-q3', 'Manila Evening Camp B',
   'evening', 20, 100, 'scheduled', '2026-07-20T18:00:00Z',
   '2026-07-24T22:00:00Z', '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z'),
  ('los-angeles-2026-q3-morning', 'los-angeles-2026-q3', 'Los Angeles Morning Camp',
   'morning', 20, 50, 'scheduled', '2026-08-10T08:00:00Z',
   '2026-08-14T12:00:00Z', '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z'),
  ('los-angeles-2026-q3-evening', 'los-angeles-2026-q3', 'Los Angeles Evening Camp',
   'evening', 20, 50, 'scheduled', '2026-08-17T18:00:00Z',
   '2026-08-21T22:00:00Z', '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z')
ON CONFLICT (id) DO NOTHING;

INSERT INTO academy_refund_policies (id, name, summary, created_at, updated_at)
VALUES
  ('residency-standard-refund', 'Residency Standard Refund Policy',
   'Cancelled residency seats can be reviewed for refund or waitlist release before the camp begins.',
   '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z'),
  ('access-grant-direct-payment', 'Access Grant Direct Payment Policy',
   'Access Grants prefer direct payment to a verified school or vendor and do not require repayment or employment.',
   '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z')
ON CONFLICT (id) DO NOTHING;
...
--   GRANT SELECT, INSERT                ON academy_library_resources         TO florence_api;
