...
function Kicker({ text }: { text: string }) {
  return (
    <p className="text-sm font-medium mb-4 text-florence-teal-dark sm:mb-6">{text}</p>
  );
}
        ...
        switch (b.kind) {
          ...
          case "callout": {
            ...
            return (
              ...
              >
                <p className={`text-sm font-medium mb-1 ${s.chip}`}>
                  {s.label} · {b.title}
                </p>
    ...
    <div className="w-full">
      ...
      {revealed && (
        <div className="mt-5 rounded-2xl border-l-4 border-florence-teal bg-florence-teal-soft/40 px-5 py-4">
          <p className="text-sm font-medium mb-1 text-florence-teal-dark">
            Answer · {item.answer}
          </p>
