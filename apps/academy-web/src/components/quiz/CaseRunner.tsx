  ...
  if (s.phase === "case-complete") {
    ...
    return (
      <div className="mx-auto max-w-2xl px-5 py-16">
        <p className="text-sm font-medium">Case {s.answeredCaseCount} complete</p>
        ...
        <div className="fl-card mt-6 p-5">
          ...
          <p className="mt-1 text-sm text-florence-slate">
            Florence re-estimated your ability and is choosing the next case to
...
function ClimbSummary({
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 pt-10">
      <p className="text-sm font-medium">Unfolding-case session</p>
