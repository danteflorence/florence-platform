 ...
 * Florence voice coach, and a simple way for the learner to mark one cleared.
 */
...
export default function Account() {
  ...
  if (!apiEnabled) {
    return (
      <Shell>
        <AlertBanner tone="warning" title="Accounts aren't enabled here">
          <p>
  ...
  return (
    <Shell>
      <div className="flex items-start justify-between gap-4">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.12em] text-florence-slate">Your account</p>
...
function VerifyBanner({ email }: { email?: string }) {
  ...
  return (
    <AlertBanner tone="warning" title="Verify your email." className="mt-5">
    ...
    <div className="fl-card mt-6 p-6">
      ...
      {paid ? (
        <div className="mt-3 space-y-4">
          ...
          <p className="rounded-lg border border-florence-line bg-white px-3 py-2 text-sm text-florence-slate">
            Application fee coverage is eligible and tracked by Florence when
            you apply to a partner program.
          </p>
          {autoEnroll && (
...
function AuthForms() {
  ...
  return (
    <div className="mx-auto max-w-md">
      <p className="text-xs font-semibold uppercase tracking-[0.12em] text-florence-slate">Florence Academy</p>
