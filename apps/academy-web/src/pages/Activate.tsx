...
function NeedCode() {
  return (
    <div className="rounded-2xl border border-florence-line bg-white p-6 sm:p-8">
      <p className="text-sm font-medium">Partner activation</p>
...
function NotFound({ code }: { code: string }) {
  return (
    <div className="rounded-2xl border border-florence-line bg-white p-6 sm:p-8">
      <p className="text-sm font-medium text-vital-danger">Code not recognized</p>
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-2xl border border-florence-line bg-white p-6">
        <p className="text-sm font-medium text-florence-indigo-dark">Coming next</p>
...
function Block({
  ...
  return (
    <div className="rounded-2xl border border-florence-line bg-white p-6">
      <p className="text-sm font-medium text-florence-teal-dark">{eyebrow}</p>
