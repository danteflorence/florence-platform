    ...
    <div>
      ...
      <section className="relative overflow-hidden border-b border-florence-line bg-white">
        ...
        <div className="relative mx-auto max-w-6xl px-5 py-12 sm:px-8">
          ...
          <ApplyProgramsCta placement="class_page" compact className="mt-5 max-w-2xl" />

          <div className="mt-8 grid gap-6 lg:grid-cols-[1.4fr_1fr]">
            <div className="fl-card p-5">
              <p className="text-sm font-medium mb-3">Learning objectives</p>
            ...
            <div className="fl-card p-5">
              <p className="text-sm font-medium mb-3">Timing</p>
      ...
      <div className="mx-auto max-w-3xl px-5 pb-16 sm:px-8">
        ...
        <ApplyProgramsCta placement="class_completion" compact className="mb-4 mt-4" />
        <Link
          to="/academy/practice"
